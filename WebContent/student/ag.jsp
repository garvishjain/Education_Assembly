...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Diploma in Agriculture</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
        ...
        <div class="container margin_60">
 		...
 		<div class="row">
           ...
           <div class="col-md-9">
           <div class="btn-group" >
  			<a href="ag.jsp"><button>Summary</button></a>
  			 <a href="ag_c.jsp"><button>Colleges</button></a>
				...
				<h4 class="h"><strong>About Diploma in Agriculture </strong></h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
            	<p>
            	Diploma in Agriculture is a Diploma course which can be pursued by a student who is interested in the research and development in the field of agriculture. The duration of the course is of 2 years which consists of 4 Semesters. Diploma in Agriculture course deals with various areas of agriculture such as genetics, soil science, seed production, horticulture, and dairy farming. The job prospects for this course is very high in demand. Graduates of Diploma in Agriculture can find employment in the Public and Private sectors in the Country. Agriculture is considered one of the evergreen industry which one can work with. Some of the job avenues for a candidate are Agricultural officer, Agricultural scientist, and Agricultural Analyst. One can take up self-employment in agriculture as well.
            	</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4  class="h"><strong> Diploma in Agriculture Course Details</strong></h4>
...
<td>Course Duration of Diploma in Agriculture is 2 Years.</td>
</tr>
<tr>
<td><strong>Age</strong></td>
 <td>Minimum age limit is 16 years</td>
</tr>
<tr>
...
<td>English, Science, Mathematics</td>
</tr>
<tr>
<td><strong>Average Fees Incurred</strong></td>
<td>Average fees incurred for the course is INR 5000 to 1 Lakh per Annum</td>
</tr>
<tr>
<td><strong>Similar Options of Study</strong></td>
<td>B.Sc Agriculture, B.Tech Agriculture</td>
</tr>
<tr>
<td><strong>Average Salary Offered</strong></td>
<td>The average salary offered is INR 3,50,000 Lakh Per Annum</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Research Associate, Lecturer, Agricultural Inspector, Agricultural Ecologist, Agronomists</td>
</tr>
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
<h4><strong>Eligibility</strong></h4><br>
<p>The eligibility criteria to apply for admission into the Diploma in Agriculture programme is pretty straightforward. The applicants have to be simply Xth qualified from a recognised Board with a minimum of 50 % aggregate to be considered eligible to pursue the Diploma in Agriculture course.&nbsp;</p>
                   </div>
                    </div>
