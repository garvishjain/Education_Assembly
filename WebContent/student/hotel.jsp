...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Diploma in Hotel Management</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
        ...
        <div class="container margin_60">
 		...
 		<div class="row">
           ...
           <div class="col-md-9">
           <div class="btn-group" >
  			<a href="hotel.jsp"><button>Summary</button></a>
  			 <a href="hotel_c.jsp"><button>Colleges</button></a>
				...
				<h4 class="h"><strong>About Diploma in Hotel Management </strong></h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
            	<p>Diploma in Hotel Management is a Diploma course in the management spectrum. The duration of the course is 3 years. Hotel Management is a subject that lays emphasis on the management of a hotel and hospitality sector in the country, management and maintenance are some of the jobs that are carried out by the candidates of the course. The diploma in hotel Management graduates has various job opportunities that are available in the hospitality and management sectors.</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4  class="h"><strong> Hotel Management Course Details</strong></h4>
...
<td>Course Duration of Diploma in Hotel Management is 3 Years.</td>
</tr>
<tr>
...
<td>50% in (10+2) from any recognized board in India</td>
</tr>
<tr>
<td><strong>Subjects Required</strong></td>
<td>English, Hindi, Hospitality laws, Facility arrangements</td>
</tr>
<tr>
<td><strong>Average Fees Incurred</strong></td>
<td>INR 10,000 to INR 1,50,000 PER ANNUM</td>
</tr>
<tr>
<td><strong>Similar Options of Study</strong></td>
<td>Bachelors in Hotel Management</td>
</tr>
<tr>
<td><strong>Average Salary Offered</strong></td>
<td>INR 2,00,000 TO INR 8,00,000 PER ANNUM</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Bar Manager. Maintenance Manager, Front Office Manager, Hotel Assistant, Restaurant Manager, Guest Relation Executive</td>
</tr>
<tr>
<td><strong>Placement Opportunities</strong></td>
<td>Hotel Administration Management, Colleges and Universities, Hotel Industry, Tourism Industry</td>
</tr>
</tbody>
</table>
                   </div>
...
<p>Listed below are the minimum criteria required for taking admission in Diploma in Hotel Management:</p>

<ul>
	<li >Successful qualification of the 10+2 level of education in any stream, from a recognized educational Board.</li>
	<li >A minimum aggregate score of 50% (5% relaxation for SC/ST/OBC candidates) at the 10+2 level.</li>
</ul>
                   </div>
                    </div>
