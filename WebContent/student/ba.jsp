    ...
    <!--Header File-->	
	 <%@ include file="itc/header.jsp" %>
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Bachelor of Arts (BA)</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
        ...
        <div class="container margin_60">
 		...
 		<div class="row">
           ...
           <div class="col-md-9">
           <div class="btn-group" >
  			<a href="ba.jsp"><button>Summary</button></a>
  			 <a href="ba_c.jsp"><button>Colleges</button></a>
...
<p>BA course helps in enriching one's outlook towards society and building it by the oldest forms of arts. There are various colleges available for BA course aspirants, that provide the best education. Many different specialisations available under BA subjects makes the course unique and diverse than other main courses. BA job scope is very wide and evergreen                  
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4  class="h">BA Course Details</h4><br>
...
<td>Course Duration of Bachelor of Arts [BA] is 3 Years.</td>
</tr>
<tr>
<td><strong>Age</strong></td>
<td>Minimum age limit is 17 years</td>
</tr>
<tr>
...
<td>Any stream at 10+2 level from a recognized university or board</td>
</tr>
<tr>
<td><strong>Average Fees Incurred</strong></td>
<td>The average BA course fees in India ranges from INR 4,000 - 65,000 per annum</td>
</tr>
<tr>
<td><strong>Similar Options of Study</strong></td>
<td>BFA, BVA, BVC, BA LLB, BA+MA</td>
</tr>
<tr>
<td><strong>Average Salary Offered</strong></td>
<td>The average BA course salary in India is INR 4.25 lakh per annum</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Executive Assistant, HR Manager, Content Writer, Operations Manager, Graphic Designer, Primary School Teacher, Marketing Manager, Computer Operator, Customer Service Representative (CSR) etc.</td>
</tr>
            	...
            	<div class="wrapper_indent">
                    <div class="row">
                    	...
                    	<h4 class="h">Eligibility Criteria for B.A.</h4>
							<p>
