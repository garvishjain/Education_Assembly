           ...
           <div class="col-md-9">
            	...
            	<div class="wrapper_indent">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6">
                        	<p><img src="img/course_1_2_thumb.jpg" alt="" class="img-responsive"></p>
                    ...
                    <div class="row">
                    	<div class="col-md-5 col-sm-5">
                        	<ul class="list-unstyled">
                            	<li><a href="#0" class="button_download hvr-sweep-to-right"><i class="pe-7s-map"></i>Prospectus</a></li>
                                <li><a href="#0" class="button_download hvr-sweep-to-right"><i class="pe-7s-note"></i>Admission form</a></li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6">
                        	<ul class="list-unstyled">
