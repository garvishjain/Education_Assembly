...
<script type="text/javascript">
	function contact() {
		...
		if (msg=="") 
					{
						document.getElementById("msgerr").innerHTML = "Please Type Message";
						return false;
					} 
					else 
					{
			...
			<div class="row">
				...
				<% } %>
						...
						<div class="wrapper_indent">
							...
							<form action="../Contact_Us" method="post" onsubmit="return contact()">
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea rows="5" id="message" name="msg"
