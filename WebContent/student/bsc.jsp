...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Bachelor of Science (BSC)</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
           ...
           <div class="btn-group" >
  			<a href="bsc.jsp"><button>Summary</button></a>
  			 <a href="bsc_c.jsp"><button>Colleges</button></a>
				...
				<h4 class="h">About Bachelor of Science (BSC)</h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
                  <p>
                  
									Bachelor of Science is a three years course that deals with a variety of research-oriented studies of science under several streams and also focuses on application of science concepts in real-life scenarios. The course is built on science fundamentals and consists of various specialization streams such as physics, chemistry, mathematics, biology, and much more. Graduates of this course have diverse job opportunities in the world of research and development. B.Sc graduates primarily work as scientists, research scholars, specialists, and R&D industry experts.                  
                  &nbsp;</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
...
<td>Course Duration of Bachelor of Science [B.Sc] is 3 Years.</td>
</tr>
<tr>
...
<td>INR 10,000 - 2 LPA</td>
</tr>
<tr>
<td><strong>Average Salary Offered</strong></td>
<td>INR 6.04 LPA [Source: Payscale]</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Anesthesiologist, Scientist, Lecturer, Biology Researcher, Scientist Assistant, Laboratory Technician, Chemist, Research Analyst, Professor, Technical Writer/ Editor, Pharmacist, Plant Biochemist etc.</td>
</tr>
</tbody>
</table>
                    ...
                    <div class="row">
                    	<div>
						<h2 id="b.sc-eligibility-criteria">Eligibility Criteria for B.Sc</h2>
<p>For B.Sc <strong>admission</strong>, students should have completed their 10+2 schooling with a minimum of <strong>50% </strong>of marks with either<strong> science or maths</strong> as mandatory subjects. <strong><br><br>Age </strong>is not a factor for eligibility as the coursework accepts students across all age groups. Selective universities require students to clear university-level <strong>entrance examinations</strong> for the admission process.</p>
