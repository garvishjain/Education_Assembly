...
.sub_header.bg_g h1 {
    font-size: 20px;
    color: #212122;
    margin: 185px 245px -172px -300px;
		...
		<div class="merge_heading">
			...
			<div class="col_heading">
				<h1 style="font-family: Georgia;" class="heading">
					<b    style=" margin: 0px 0px 0px 174px;">MADHAV INSTITUTE OF TECHNOLOGY AND SCIENCE , GWALIOR (MITS)</b>
				</h1>
			</div>
		</div>
	</div>
