...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Bachelor of Computer Application</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
        ...
        <div class="container margin_60">
 		...
 		<div class="row">
           ...
           <div class="col-md-9">
           <div class="btn-group" >
  			<a href="bca.jsp"><button>Summary</button></a>
  			 <a href="bca_c.jsp"><button>Colleges</button></a>
				...
				<h4 class="h">About Bachelor of Computer Application (BCA))</h4>
				<p></p>
			</div>
            	...
            	<p>Bachelor in Computer Application (BCA) is an undergraduate degree course in computer applications. With the rapid growth of IT industry in India, the demand of computer professional is increasing day by day. This increasing growth of IT industry has created a lot of opportunities for the computer graduates .</p>
                  <p>
							...
							Bachelor of Computer Application is a three-year-long undergraduate programme, which predominantly focuses on computer science and its application concepts. It prepares students to study data structures, database systems and computer networks. The course consists of six semesters and has a large scope for undergraduates as most industries require computer applications and experts for a smooth run of their business.                  
                   &nbsp;</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4 class="h">BCA Course Details</h4>
                    	<br>
...
<td>Course Duration of Bachelor of Computer Application [BCA] is 3 Years.</td>
</tr>
<tr>
...
<td>It is open for students who have qualified Higher Secondary Examination with a minimum of 45% marks</td>
</tr>
<tr>
<td><strong>Average Fees Incurred</strong></td>
<td>INR 15,000 - 2 LPA</td>
</tr>
 <tr>
...
<td>Software Developer Trainee, Trainee Programmer, Technical Analyst, Technical Support, Server Monitoring, Networking Trainee, System Administrator-Computer, Server Administrator etc.</td>
</tr>
</tbody>
</table>
                    ...
                    <div class="row">
                    	<div>
					<h4 class="h">Eligibility Criteria for BCA</h4><br>
<p>BCA course eligibility criteria depend on the college that students are interested in applying for. Many factors would influence the eligibility, such as infrastructure, number of students applying for the course, location of the college etc.</p>
<p>Below are some of the general criteria followed by most universities:</p>
<ul>
<li aria-level="1">Students must pass their 10+2 from a recognized board</li>
<li aria-level="1">Apart from the eligibility mentioned above criteria, various colleges and institutes may have their examinations, which the students would have to clear with good scores to take admission.&nbsp;</li>
</ul>
</div>
