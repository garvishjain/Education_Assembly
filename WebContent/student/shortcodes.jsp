...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1><strong>Shortcodes</strong> page</h1>
        ...
        <div class="container margin_60">
                        ...
                        <ul>
                            ...
                            <div class="tooltip_styled tooltip-effect-4">
                               <span class="tooltip-item">Tooltip</span>
                                 <div class="tooltip-content">Dedicated Study Plan</div>
                            </div>
                            </li>
                              <li>
                            <div class="tooltip_styled tooltip-effect-4">
                               <span class="tooltip-item">Another tooltip</span>
                                 <div class="tooltip-content">Admission Deadline 31/11/2015</div>
                            </div>
                            </li>
                        </ul>
                  </div><!-- End col-md-6-->
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Anim pariatur cliche reprehenderit?<i class="indicator icon_minus_alt2 pull-right"></i></a>
                      </h4>
                    </div>
               ...
               <div class="row magnific-gallery">
                   <div class="col-md-6">
                   		<a href="img/course_2.jpg" title="Photo title"><img src="img/course_2.jpg" alt="" class="img-responsive"></a>
                   </div>
                   <div class="col-md-6">
                   		<a href="img/course_3.jpg" title="Photo title"><img src="img/course_3.jpg" alt="" class="img-responsive"></a>
                   </div>
               </div><!-- End row-->
               ...
               <div class="row magnific">
                   <div class="col-md-6">
                   		<a href="https://vimeo.com/45830194" class="video_pop" title="Video title"><img src="img/course_4.jpg" alt="" class="img-responsive"></a>
                   </div>
                   <div class="col-md-6">
                   		<a href="https://www.youtube.com/watch?v=Zz5cu72Gv5Y"  class="video_pop" title="Video title"><img src="img/course_5.jpg" alt="" class="img-responsive"></a>
                   </div>
               </div><!-- End row-->
                 </div>
            </div><!--End Container -->
