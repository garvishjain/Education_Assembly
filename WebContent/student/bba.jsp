...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Bachelor of Business Administration (BBA)</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
           ...
           <div class="btn-group" >
  			<a href="bba.jsp"><button>Summary</button></a>
  			 <a href="bba_c.jsp"><button>Colleges</button></a>
				...
				<h4 class="h">About Bachelor of Business Administration</h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
            	<p>
            	<strong>Bachelor of Business Administration</strong> or<strong>BBA</strong> is one of the most popular bachelor degree programmes after class XII. The BBA course is the gateway to numerous job opportunities in a plethora of sectors like Marketing, Education, Finance, Sales, and Government to name just a few.  Here are some important highlights of the BBA program/degree that you should know about:
            	</p>
            	<ul> 
 <li>The 3-year professional undergraduate course in Business Management is open to students from all the three streams: Science, Arts and Commerce.</li> 
 <li>The BBA course offers knowledge and training in management and leadership skills to prepare them for managerial roles and entrepreneurship.</li> 
 <li>During the tenure of the course, candidates learn various aspects of business administration and management through class room lectures and practical projects like internship.</li> 
 <li>BBA can be pursued in full-time as well as correspondence mode.</li> 
 <li>There are various BBA specializations one can choose from such as 
  <ul> 
 ...
 <li>The average starting salary of a BBA graduate is on an average Rs 3 lakh and upwards.</li> 
</ul>
                   &nbsp;</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4  class="h">BBA Course Details</h4>
...
<td>Course Duration of Bachelor of Business Administration [BBA] is 3 Years.</td>
</tr>
<tr>
<td><strong>Age</strong></td>
<td>Between 17 and 25</td>
</tr>
<tr>
<td><strong>Minimum Percentage</strong></td>
<td>50% in 10+2 from a recognised board</td>
</tr>
<tr>
<td><strong>Subjects Required</strong></td>
<td>English in 10+2</td>
</tr>
<tr>
<td><strong>Average Fees Incurred</strong></td>
<td>The average BBA course fee ranges from INR 1 to 2.5 lakh per annum</td>
</tr>
<tr>
<td><strong>Similar Options of Study</strong></td>
<td>BBS, BBM, B.Com, BMS</td>
</tr>
<tr>
<td><strong>Average Salary Offered</strong></td>
<td>The average BBA salary is INR 4.2 lakhs per annum</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Information Systems Manager, Business Administration Professor, Production Manager, Finance Manager, Human Resource Manager, Business Administration Researcher, Management Accountant etc.</td>
</tr>
</tbody>
</table>
            	...
            	<div class="wrapper_indent">
                    <div class="row">
                    	...
                    	<h4 class="h">Eligibility Criteria for BBA</h4>
							<p>
									<ul>
											<li>Aspirants who have completed their Class XII (10+2 level) in any stream from a recognised educational board or university can pursue BBA .</li>
											<li>The candidates must have attained an aggregate score of 50% and above in Class XII .</li>
											<li>In case a candidate has appeared for Class XII exam and is waiting for the result, s/he can also apply to the course.</li>
									</ul>
