...
<div id="preloader">
    ...
    <div class="container-fluid">
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Masters of Business Administration (MBA)</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
        ...
        <div class="container margin_60">
           ...
           <div class="btn-group" >
  			<a href="mca.jsp"><button>Summary</button></a>
  			 <a href="mca.jsp"><button>Colleges</button></a>
				...
				<h4 class="h">About Masters of Business Administration (MBA)</h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
                  <p>MBA&nbsp;is an internationally accredited post-graduate degree for&nbsp;developing business and management skills amongst future business leaders and entrepreneurs. The full form of MBA is Master of Business Administration. A typical MBA degree covers a wide range of business fields like accounting, marketing &amp; management. An MBA degree is not limited to a career in management so those interested in pursuing a career in the private, government &amp; public sector can also benefit from an MBA degree. &nbsp;</p><p>In India specifically, there are two types of management degrees available.</p><ul><li><u>Masters in Business Management (MBA):</u> This degree is offered usually a 2-year degree.</li><li><u>Post Graduate Diploma in Management (PGDM):</u> This degree is offered by autonomous institutes like the Indian Institute of Management(s)</a> and is usually a 1-year course.</li></ul><p>In recent times, various other versions of MBA/ PGDM have been introduced to adhere to the industry needs. Some of them include:</p><ul><li>Online MBA</a></li><li>Distance Learning MBA</a></li><li>Executive MBA</a></li></ul><p>The MBA course curriculum is a combination of some core subjects like Marketing, Economics, Accounting and Operations, and Elective courses to give management aspirants a chance to follow their own personal or professional interests. &nbsp;</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
		 ...
		 -->	</div>
            	<div class="wrapper_indent">
                    <div class="row">
                    	<h4  class="h">MBA Specializations</h4>
	<p >Take a look at the table&nbsp;below to know about some of the MBA specializations.</p>
	<table >
			...
			<tr>
            	...
            	<div class="wrapper_indent">
                    <div class="row">
                    	...
                    	<h4 class="h">Masters of Business Administration (MBA) Eligibility Criteria</h4><p><p>Admission to the MBA course is&nbsp;strictly on the basis of management entrance exams conducted on national, state, university/institute level. Besides this, students have to adhere to the following eligibility criteria:</p><ul><li>Graduate from any stream with minimum 50% marks or equivalent CGPA from a UGC recognized Board or equivalent recognition from MHRD,</li><li>Students belonging to the SC/ ST or PWD category will require a minimum 45% marks to qualify for any MBA entrance test</li><li>Valid scores of MBA entrance exams like CAT, MAT, XAT, SNAP, NMAT &amp; CMAT etc.</li></ul>
