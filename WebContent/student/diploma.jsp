                    ...
                    <div class="col-md-9">
                        ...
                        <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="img_list">
                                        <a ><img src="img/course/d2.jpg" alt="">
                                        <div class="short_info">
                                            <h3>Agriculture</h3>
                                        </div>
                                        </a>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="course_list_desc">
                                        <h3><strong>Diploma in Agriculture</strong> </h3>
                                        <p>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="details_list_col">
                                        <div>
                                            <a href="ag.jsp" class="button_outline">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="img_list">
                                        <a ><img src="img/course/d3.jpg" alt="">
                                        <div class="short_info">
                                            <h3>Commerce</h3>
                                        </div>
                                        </a>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="course_list_desc">
                                        <h3><strong>diploma in commerce</strong> </h3>
                                        <p>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="details_list_col">
                                        <div>
                                            <a href="commerce.jsp" class="button_outline">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="img_list">
                                        <a ><img src="img/course/d4.png" alt="">
                                        <div class="short_info">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="course_list_desc">
                                        <h3><strong>Diploma in Computer Application</strong></h3>
                                        <p>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="details_list_col">
                                        <div>
                                            <a href="ca.jsp" class="button_outline">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="strip_all_courses_list wow fadeIn" data-wow-delay="0.1s">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <div class="img_list">
                                        <a href=""><img src="img/course/d5.png" alt="">
                                        <div class="short_info">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="course_list_desc">
                                        <h3><strong>DIPLOMA IN HOTEL MANAGEMENT
</strong> </h3>
                                        <p>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2">
                                    <div class="details_list_col">
                                        <div>
                                            <a href="hotel.jsp" class="button_outline">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <ul id="contacts_footer">
                        ...
                        <li>Email - <a href="#">info@educationassembly.com</a> <!-- / <a href="#">office@atena.com</a></li> -->
                    </ul>
                </div>
            </div><!-- End row -->
        </div><!-- End container -->
