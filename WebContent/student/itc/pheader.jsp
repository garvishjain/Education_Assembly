	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-3">
				<div id="logo">
					<a href="index.html"><img src="img/logo.png" width="125"
						height="40" alt="Atena" data-retina="true"></a>
				</div>
			</div>
			...
			<li class="submenu"><a href="javascript:void(0);"
						class="show-submenu">Complete Your Profile <i class="icon-down-open-mini"></i></a>
						<ul>
							<li><a href="about.jsp">Upload Documents</a></li>
							<li><a href="contacts.jsp">Check Status</a></li>
						</ul></li>
					
					<li><a href="#" data-toggle="modal" data-target="#login">Log-out</a></li>
