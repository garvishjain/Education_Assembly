   ...
   <!--Header File-->	
	 <%@ include file="itc/header.jsp" %>
        ...
        <div class="sub_header bg_1">
        	<div id="intro_txt">
			<h1> <strong>Bachelor of Engineering</strong> </h1>
            <p></p>
            </div>
		</div> <!--End sub_header -->
           ...
           <div class="btn-group" >
  			<a href="bba.jsp" ><button>Summary</button></a>
  			 <a href="bba_c.jsp" ><button>Colleges</button></a>
				...
				<h4 class="h">About Bachelor of Engineering (B.E.)</h4>
				<p></p>
			</div>
            	<div class="wrapper_indent">
                  <p>
                  BE full form is  Bachelor of Engineering . It is a professional degree program comes up with a duration of 4 years having 8 semesters. BE course focuses mainly on the scientific theory concepts and experiments, later making it a reality. An engineering degree is considered one of the reputed course all around the world since it helps in the development of countries by implementing the latest trends in technology. Mechanical Engineering, Electrical Engineering, Civil Engineering branches are considered as mother branches of Engineering. Computer Science Engineering, Electronics & Communication Engineering, Mechatronics, Aerospace Engineering etc are the most demanding branches which are derived from the domain branches.
                   &nbsp;</p>
                      <!--  <div class="row">
                    	<div class="col-md-6">
...
<td>Course Duration of Bachelor of Engineering [BE] is 4 Years.</td>
</tr>

<td><strong>Minimum Percentage</strong></td>
<td>60% in 10+2 from a recognized Board of Education</td>
</tr>
<tr>
<td><strong>Subjects Required</strong></td>
<td>Physics, Chemistry, Maths with Biology / Computer Science / Electronics</td>
</tr>
...
<td>The average BE salary is INR 6.53 lakhs per annum</td>
</tr>
<tr>
<td><strong>Employment Roles</strong></td>
<td>Design Engineer, Quality Control Engineer, Development Engineer, Computer Architect, Hardware & Network Administrator, Computer Operator, Professor, Technical Engineer, Computer Hardware Engineer etc</td>
</tr>
<tr>
