...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <h6 class="brand-name">Admin<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h6>
        ...
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        <li><a href="admin-manager.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
            ...
            <div class="tab-pane fade" id="menu-college" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        <li><a href="admin-manager.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                        <li><a href="Collegeprofessors.jsp"><i class="fa fa-black-tie"></i><span>Professors</span></a></li>
