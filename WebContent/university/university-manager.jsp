...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="university-manager.jsp"><i class="fa fa-graduation-cap brand-logo"></i></a>
                <div class="dropdown">
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu-college">Colleges</a></li> 
        </ul>
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        <li class="active"><a href="university-manager.jsp"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                        <li><a href="university-register.jsp"><i class="fa fa-graduation-cap brand-logo"></i><span>University Register</span></a></li>
