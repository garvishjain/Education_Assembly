            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="professors.jsp"><i class="fa fa-black-tie"></i><span>Professors</span></a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 border-style mb-0">
                                ...
                                <tr>
                                	...
                                	<td><span class="tag tag-success"><%=rs.getString("position") %></span>
                        	...
                        	<div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="card">
                                    ...
                                    %>
                                    	...
                                    	<h5 class="mb-0"><%=rs.getString("fname")+" "+rs.getString("lname") %></h5>
                                    	<span><%=rs.getString("department") %></span>
                                    	 <div class="text-muted"><%=rs.getInt("phone") %></div>
                                    	 <p class="mb-4 mt-3"><%=rs.getString("email") %></p>
